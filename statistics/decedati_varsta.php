...
<head>
    ...
    <?php
        ...
        $query = "SELECT * FROM decedati_varsta";
        ...
        $query = "SELECT SUM(decedati) FROM decedati_varsta";
        $result = mysqli_query($conn, $query);
...
<body>
    ...
    <div class="row">
        <div class="container">
            <div class="col s12">
                <h4 class="center">Decedati in functie de clase de varsta</h4>
            </div>
            <div class="col s8 offset-s2 center">
                <p>Aceasta statistica prezinta situatia deceselor Romaniei, grupate in functie de clase de varsta. Datele au fost actualizate in anul 2014, cand s-a realizat ultimul recensamant, in care s-au inregistrat <b><?=$sum?></b> decese.</p>
            </div>
        </div>
    </div>
            ...
            <div id="tabular" class="col s12">
                ...
                <table class="striped highlight centered" id="sort" class="tablesorter">
                    ...
                    <tbody>
                        <?php
                            $conn = mysqli_connect("localhost", "root", "", "demo");
                            mysqli_select_db($conn, "decedati_varsta");
                            $query = "SELECT * FROM decedati_varsta";
                            $result = mysqli_query($conn, $query);
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr>";
                                echo "<td>" . $row['varsta'] . "</td><td>" . $row['decedati'] . "</td></tr>";
                            }
                            echo "</table>";
                        ?>
                    </tbody>
