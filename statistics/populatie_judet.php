...
<head>
    ...
    <?php
        ...
        $query = "SELECT * FROM populatie_judet";
        ...
        $query = "SELECT SUM(populatie) FROM populatie_judet";
        $result = mysqli_query($conn, $query);
...
<body>
    ...
    <div class="row">
        <div class="container">
            <div class="col s12">
                <h4 class="center">Populatia in functie de judet</h4>
            </div>
            <div class="col s8 offset-s2 center">
                <p>Aceasta statistica prezinta situatia populatiei Romaniei, grupata in functie de judete. Datele au fost actualizate in anul 2014, cand s-a realizat ultimul recensamant, in care s-a inregistrat o populatie de <b><?=$sum?></b> de oameni.</p>
            </div>
        </div>
    </div>
            ...
            <div id="tabular" class="col s12">
                ...
                <table class="striped highlight centered" id="sort" class="tablesorter">
                    ...
                    <tbody>
                        <?php
                            $conn = mysqli_connect("localhost", "root", "", "demo");
                            mysqli_select_db($conn, "populatie_judet");
                            $query = "SELECT * FROM populatie_judet";
                            $result = mysqli_query($conn, $query);
                            while($row = mysqli_fetch_array($result)){
                                echo "<tr>";
                                echo "<td>" . $row['judet'] . "</td><td>" . $row['populatie'] . "</td></tr>";
                            }
                            echo "</table>";
                        ?>
                    </tbody>
